  ...
  return (
    <div className="container mx-auto py-8 h-full flex flex-col items-center justify-center">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold font-headline text-primary">Explore Sickle Cell Disease</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Welcome! Select a topic to begin your quest and learn about sickle cell disease. Gain XP to unlock new subjects.
        </p>
      </div>
